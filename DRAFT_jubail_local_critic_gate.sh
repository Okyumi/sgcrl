#!/bin/bash
#SBATCH --verbose
#SBATCH --job-name=jubail_locgate
...
#SBATCH --mem=64GB
#SBATCH --output=/scratch/yd2247/sgcrl/logs/local_critic_gate/runs/%A_%a.out
#SBATCH --error=/scratch/yd2247/sgcrl/logs/local_critic_gate/runs/%A_%a.err
#SBATCH --mail-user=yd2247@nyu.edu
#SBATCH --mail-type=FAIL
#SBATCH --array=0-3

# Local-σ_s critic-gated Success-BC. Seed 6, paper stack.
...
export CONFIG_SCRIPT="experiment_configs_local_critic_gate.py"
export CONFIG_INDEX_OFFSET=0
export CONFIG_LIMIT=4
export TASKS_PER_GPU=1
export XLA_PYTHON_CLIENT_MEM_FRACTION=0.75
export LOG_DIR="/scratch/yd2247/sgcrl/logs/local_critic_gate/runs"
export CHECKPOINT_DIR="/scratch/yd2247/sgcrl/logs/local_critic_gate/checkpoints"
export WANDB_PROJECT="${WANDB_PROJECT:-continual_gcrl_paper}"
export WANDB_GROUP="${WANDB_GROUP:-PAPER-DCC-LOCAL-CRITICGATE-4758}"
...
echo "Local critic-gate cell ${CONFIG_IDX} finished."
