...
#SBATCH --mem=64GB
#SBATCH --output=/scratch/yd2247/sgcrl/logs/first_success_window_bc/runs/%A_%a.out
#SBATCH --error=/scratch/yd2247/sgcrl/logs/first_success_window_bc/runs/%A_%a.err
#SBATCH --mail-user=yd2247@nyu.edu
#SBATCH --mail-type=FAIL
#SBATCH --array=0-3

# First-success window Success-BC: clone [t_first-K+1, t_first] iff the
# last sparse bit is still 1. Same λ=0.1 as the paper Success-BC cells.
...
export CONFIG_SCRIPT="experiment_configs_first_success_window_bc.py"
export CONFIG_INDEX_OFFSET=0
export CONFIG_LIMIT=4
export TASKS_PER_GPU=1
export XLA_PYTHON_CLIENT_MEM_FRACTION=0.75
export LOG_DIR="/scratch/yd2247/sgcrl/logs/first_success_window_bc/runs"
export CHECKPOINT_DIR="/scratch/yd2247/sgcrl/logs/first_success_window_bc/checkpoints"
export WANDB_PROJECT="${WANDB_PROJECT:-continual_gcrl_paper}"
export WANDB_GROUP="${WANDB_GROUP:-PAPER-DCC-FIRST-SUCCESS-WINDOW}"
...
python tests/test_first_success_window_bc.py
...
echo "First-success window Success-BC cell ${CONFIG_IDX} finished."
