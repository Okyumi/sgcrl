#!/bin/bash
#SBATCH --verbose
#SBATCH --job-name=task58_dcc_fixed
...
#SBATCH --mem=72GB
#SBATCH --output=/scratch/yd2247/sgcrl/logs/task58_dcc_corrected_%A_%a.out
#SBATCH --error=/scratch/yd2247/sgcrl/logs/task58_dcc_corrected_%A_%a.err
...
export LOG_DIR="/scratch/yd2247/sgcrl/logs/task58_dcc_corrected/runs"
export CHECKPOINT_DIR="/scratch/yd2247/sgcrl/logs/task58_dcc_corrected/checkpoints"
