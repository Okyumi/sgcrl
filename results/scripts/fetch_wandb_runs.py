...
DIAGNOSTIC_KEYS = [
    ...
    "learner/shortcut/hand_goal_shuffled_categorical_accuracy",
    "learner/shortcut/gripper_goal_shuffled_categorical_accuracy",
    "learner/shortcut/mechanism_goal_shuffled_categorical_accuracy",
    "learner/shortcut/hand_goal_shuffle_drop",
    "learner/shortcut/gripper_goal_shuffle_drop",
    "learner/shortcut/mechanism_goal_shuffle_drop",
    ...
    "learner/action_landscape/score_vs_one_step_full_progress_spearman",
    "learner/action_landscape/score_vs_one_step_mechanism_progress_spearman",
    "learner/action_landscape/score_vs_rollout_full_progress_spearman",
    "learner/action_landscape/score_vs_rollout_mechanism_progress_spearman",
    "learner/action_landscape/score_vs_success_spearman",
    "learner/action_landscape/top_score_one_step_full_progress_regret",
    "learner/action_landscape/top_score_one_step_mechanism_progress_regret",
    "learner/action_landscape/top_score_rollout_full_progress_regret",
    "learner/action_landscape/top_score_rollout_mechanism_progress_regret",
    "learner/action_landscape/top_score_success_regret",
    "learner/action_landscape/replay_score_vs_rollout_mechanism_spearman",
    "learner/action_landscape/replay_top_score_regret",
    "learner/action_landscape/policy_score_percentile",
    "learner/action_landscape/policy_outcome_percentile",
    "learner/action_landscape/policy_score_outcome_percentile_gap",
    "learner/action_landscape/policy_replay_support_distance",
    "learner/action_landscape/policy_score_mean",
    "learner/action_landscape/policy_rollout_mechanism_progress_mean",
    "learner/action_landscape/policy_success_mean",
    "learner/action_landscape/local_score_mean",
    "learner/action_landscape/local_rollout_mechanism_progress_mean",
    "learner/action_landscape/local_success_mean",
    "learner/action_landscape/replay_score_mean",
    "learner/action_landscape/replay_rollout_mechanism_progress_mean",
    "learner/action_landscape/replay_success_mean",
    "learner/action_landscape/uniform_score_mean",
    "learner/action_landscape/uniform_rollout_mechanism_progress_mean",
    "learner/action_landscape/uniform_success_mean",
    "learner/action_landscape/candidate_score_std",
    "learner/action_landscape/num_candidates",
    "learner/action_landscape/num_anchors",
    ...
    "learner/dcc_sac/her_success_rate",
    "learner/dcc_sac/her_goal_distance_mean",
    "learner/dcc_sac/her_goal_distance_min",
    "learner/dcc_sac/her_goal_distance_max",
    "learner/dcc_sac/her_goal_distance_p50",
    "learner/dcc_sac/her_goal_distance_p95",
    "learner/dcc_sac/reward_mean",
    "learner/dcc_sac/discount_mean",
