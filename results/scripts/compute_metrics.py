...
Outputs (written to ``results/data/processed/``):
  ...
  - diagnostic_per_run.csv  : first/final/tail summaries for each diagnostic.
  - diagnostic_summary.csv  : across-seed diagnostic summaries by task/cell.
...
``cell_summary.csv``, ``crl_metrics.csv``,
``diagnostic_per_run.csv``, and ``diagnostic_summary.csv``.
