...
The TensorFlow replay pipeline lives in ``run_continual_contrastive.py``.
These dependency-free helpers keep its validation and batch arithmetic easy to
unit test without importing TensorFlow, Reverb, Acme, or Meta-World.
"""
