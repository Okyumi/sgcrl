#!/usr/bin/env python3
"""Run the critic feature-shortcut probe on exact env config dirs."""
...
def main():
  ...
  probe = REPO_ROOT / 'scripts' / 'measure_critic_feature_shortcut.py'
  ...
  for step, path in chosen:
    ...
    output = out_dir / f'feature_shortcut_{tag}.json'
    cmd = [
