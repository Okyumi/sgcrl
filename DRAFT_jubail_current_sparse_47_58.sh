#!/bin/bash
#SBATCH --verbose
#SBATCH --job-name=jubail_csparse
...
#SBATCH --mem=64GB
#SBATCH --output=/scratch/yd2247/sgcrl/logs/current_sparse_47_58/runs/%A_%a.out
#SBATCH --error=/scratch/yd2247/sgcrl/logs/current_sparse_47_58/runs/%A_%a.err
#SBATCH --mail-user=yd2247@nyu.edu
#SBATCH --mail-type=FAIL
#SBATCH --array=0-3

# Per-step Success-BC (clone only sparse-bit=1 transitions). Seed 6.
...
export CONFIG_SCRIPT="experiment_configs_current_sparse_47_58.py"
export CONFIG_INDEX_OFFSET=0
export CONFIG_LIMIT=4
export TASKS_PER_GPU=1
export XLA_PYTHON_CLIENT_MEM_FRACTION=0.75
export LOG_DIR="/scratch/yd2247/sgcrl/logs/current_sparse_47_58/runs"
export CHECKPOINT_DIR="/scratch/yd2247/sgcrl/logs/current_sparse_47_58/checkpoints"
export WANDB_PROJECT="${WANDB_PROJECT:-continual_gcrl_paper}"
export WANDB_GROUP="${WANDB_GROUP:-PAPER-DCC-CURRENT-SPARSE-4758}"
...
echo "Current-sparse 4/7+5/8 cell ${CONFIG_IDX} finished."
