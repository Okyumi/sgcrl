#!/bin/bash
#SBATCH --verbose
#SBATCH --job-name=dcc_norm_scale_t5
...
#SBATCH --mem=96GB
#SBATCH --output=/scratch/yd2247/sgcrl/logs/dcc_normalized_shared_scale/task5_%A_%a.out
#SBATCH --error=/scratch/yd2247/sgcrl/logs/dcc_normalized_shared_scale/task5_%A_%a.err
#SBATCH --mail-user=yd2247@nyu.edu
#SBATCH --array=0-5

# Reuse the completed Tasks 0-4 prefix checkpoints from the original alpha
# pilot. Each array task runs one alpha; seeds 5/6/7 share the GPU.
set -euo pipefail

REPO_DIR="/scratch/yd2247/sgcrl"
CONFIG_SCRIPT="experiment_configs_dcc_normalized_shared_scale_task5.py"
cd "$REPO_DIR"
...
mkdir -p /scratch/yd2247/sgcrl/logs/dcc_normalized_shared_scale
python tests/test_dcc_normalized_shared_scale.py
...
run_one() {
  ...
  local run_root="/scratch/yd2247/sgcrl/logs/dcc_normalized_shared_scale/task5/a${scale_tag}/seed${SEED}"
