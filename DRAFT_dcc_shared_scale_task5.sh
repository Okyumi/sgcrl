#!/bin/bash
#SBATCH --verbose
#SBATCH --job-name=dcc_shared_scale_t5
...
#SBATCH --mem=96GB
#SBATCH --output=/scratch/yd2247/sgcrl/logs/dcc_shared_scale/task5_%A_%a.out
#SBATCH --error=/scratch/yd2247/sgcrl/logs/dcc_shared_scale/task5_%A_%a.err
#SBATCH --mail-user=yd2247@nyu.edu
#SBATCH --array=0-5

# Task-5 branch sweep. Run DRAFT_dcc_shared_scale_task5_prefix.sh first.
# One alpha per array task; seeds 5/6/7 share the GPU.
set -euo pipefail
...
run_one() {
  ...
  local run_root="/scratch/yd2247/sgcrl/logs/dcc_shared_scale/task5_prefix6/a${scale_tag}/seed${SEED}"
