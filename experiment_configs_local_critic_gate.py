...
Current-sparse inserts (r_t=1). Gate compares action-probes at the
observed (s, g) to local state jitter of that same s. Paper stack,
λ=0.1, 4096 ring, seed 6.
...
SEED = 6
WANDB_GROUP = 'PAPER-DCC-LOCAL-CRITICGATE-4758'
PAPER_BC_DIR = (
...
def build_configs():
  return [
      _paper(
          8_000_000, 100_000,
          variant='task4_stick_local_gate',
          start_task=4,
          num_tasks=5,
      ...
      _paper(
          8_000_000, 100_000,
          variant='task7_shelf_local_gate',
          start_task=7,
          num_tasks=8,
          adapt_heads_only=True,
