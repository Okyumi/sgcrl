#!/usr/bin/env python3
"""Whole-episode Success-BC + local-σ_s critic gate on 4/7 and 5/8.

Same buffer as the paper Success-BC that retains latch tasks: if the
replay episode ever saw r=1, every transition enters D_succ. The
local critic gate is unchanged (not tightened). Paper stack, λ=0.1,
4096 ring, seed 6.
...
SEED = 6
WANDB_GROUP = 'PAPER-DCC-EPISODE-LOCALGATE-4758'
PAPER_BC_DIR = (
...
def build_configs():
  return [
      ...
      _paper(
          1_000_000, 50_000,
          variant='handle_episode_local_gate',
      ...
      _paper(
          1_000_000, 50_000,
          variant='window_episode_local_gate',
